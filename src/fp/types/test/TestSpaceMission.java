...
public class TestSpaceMission {
	...
	public static void main(String[] args) {
		...
		Payload p2 = new Payload("Trailblazer", "Communication Satellite", null, Orbit.LOWEARTHORBIT);
		...
		SpaceMission sm5 = new SpaceMission("SpaceX","Cape Canaveral", "Titan IIIIC", "Payload fairing disintegrated at T+78 seconds leading to a loss of the launch vehicle");
